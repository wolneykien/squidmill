...
install -p -m0755 -D jobs/daily %buildroot%_sysconfdir/cron.daily/squidmill
install -p -m0755 -D jobs/weekly %buildroot%_sysconfdir/cron.weekly/squidmill
install -p -m0755 -D jobs/monthly %buildroot%_sysconfdir/cron.monthly/squidmill
